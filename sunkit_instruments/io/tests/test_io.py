...
import astropy
import pytest
from sunkit_instruments import io
...
def test_io_read_suvi_files():
    ...
    L1b_nc_header, L1b_nc_data, L1b_nc_dqf = io.read_suvi(L1b_nc, return_DQF=True)
    L1b_fits_header, L1b_fits_data, L1b_fits_dqf = io.read_suvi(L1b_fits, return_DQF=True)
    L2_header, L2_data = io.read_suvi(L2_composite)
